      ...
      <div>
        <div className={classNames.controlWrapper}>
          <Toggle
            ...
            onChange={(e, checked) => this._onChangeCompactMode(e, !!checked)}
            onText="Compact"
            offText="Normal"
          ...
          <Toggle
            ...
            onChange={(e, checked) => this._onChangeModalSelection(e, !!checked)}
            onText="Modal"
            offText="Normal"
            styles={controlStyles}
          />
          <TextField label="Filter by name:" onChange={(e, text) => this._onChangeText(e, text ? text : '')} styles={controlStyles} />
